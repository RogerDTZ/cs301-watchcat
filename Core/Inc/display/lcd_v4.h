...
/* ���ò����Ĵ����ķ�ʽ����IO���������Ļ��ˢ���� */
#define LCD_BL(x)                                                              \
  LCD_BL_GPIO_PORT->BSRR = LCD_BL_GPIO_PIN << (16 * (!x)) /* ����BL���� */

#define LCD_WR(x)                                                              \
  LCD_WR_GPIO_PORT->BSRR = LCD_WR_GPIO_PIN << (16 * (!x)) /* ����WR���� */
#define LCD_RD(x)                                                              \
  LCD_RD_GPIO_PORT->BSRR = LCD_RD_GPIO_PIN << (16 * (!x)) /* ����RD���� */
#define LCD_CS(x)                                                              \
  LCD_CS_GPIO_PORT->BSRR = LCD_CS_GPIO_PIN << (16 * (!x)) /* ����CS���� */
#define LCD_RS(x)                                                              \
  LCD_RS_GPIO_PORT->BSRR = LCD_RS_GPIO_PIN << (16 * (!x)) /* ����RS���� */
...
void lcd_wr_xdata(
    uint16_t data); /* LCDд����, �ú���ͬ lcd_wr_data �����Ĺ���һģһ�� */
